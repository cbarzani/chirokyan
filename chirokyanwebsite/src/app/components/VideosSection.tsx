...
const videos = [
  {
    id: 1,
    title: 'محمد مسعود محمد چیرۆکی ژیانی خۆی دەگێڕێتەوە [بەشی یەکەم]',
    thumbnail: 'https://img.youtube.com/vi/2oolQm_baFo/maxresdefault.jpg',
    videoId: '2oolQm_baFo',
    url: 'https://youtu.be/2oolQm_baFo?si=Ba8rat4696ZFfroz'
  },
  {
    id: 2,
    title: 'مامۆستا شێرزاد عەلی چیرۆکی ژیانی خۆی دەگێڕێتەوە',
    thumbnail: 'https://img.youtube.com/vi/Zz2r49Y_uCU/maxresdefault.jpg',
    videoId: 'Zz2r49Y_uCU',
    url: 'https://youtu.be/Zz2r49Y_uCU?si=Xj84O5BFYthO9xAM'
  },
  {
    id: 3,
    title: 'حاجی هەژار نانەکەلی چیرۆکی ژیانی خۆی دەگێڕێتەوە',
    thumbnail: 'https://img.youtube.com/vi/UUc9MoprXt4/maxresdefault.jpg',
    videoId: 'UUc9MoprXt4',
    url: 'https://youtu.be/UUc9MoprXt4?si=CSSmcT6IzIjdwZ7Y'
  }
];
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {videos.map((video, index) => (
            ...
            >
              ...
              <div className="p-6">
                <h3 className="text-xl text-[#5a4a3a] mb-2 leading-relaxed">
                  {video.title}
                </h3>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-4 flex items-center justify-between gap-4">
                <div className="flex-1 min-w-0">
                  <h3 className="text-[#d4c5a9] font-semibold truncate">{activeVideo.title}</h3>
                </div>
